...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!cardsContainer) {
    console.warn("Contenedor de cards no encontrado. No se cargarán las cheatsheets.");
    return;
  }
  ...
  if (window.Prism) {
    ...
    Prism.highlightAll();
      ...
      console.warn("Prism.js no cargado o no se pudo inicializar resaltado de código.");
  }
});
