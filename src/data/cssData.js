...
background: #ccc url('pattern.png') no-repeat center / cover;`,
    ...
    footerLinkDemo: "https://codepen.io/emiarias/pen/NPGPvPq",
    footerPreview: null,
    footerVideo: null,
    section: "Colores y Fondos",
    order: 6,
...
box-sizing: border-box; /* Incluye padding y border en width/height */`,
    ...
    footerLinkDemo: 'https://codepen.io/emiarias/pen/azvzyvq',
    footerPreview: null,
    footerVideo: null,
...
.oculto { display: none; } /* No ocupa espacio, es como si no existiera */`,
    ...
    footerLinkDemo: 'https://codepen.io/emiarias/pen/EaVavgQ',
    footerPreview: null,
    footerVideo: null,
    section: "Modelo de Caja",
    order: 8,
...
font-variant: small-caps; /* o normal */`,
  ...
  footerLinkDemo: 'https://codepen.io/emiarias/pen/vENEWwV',
  footerPreview: null,
  footerVideo: null,
  section: "Tipografía",
  order: 9,
...
text-indent: 50px;`,
  ...
  footerLinkDemo: 'https://codepen.io/emiarias/pen/wBKBEaw',
  footerPreview: null,
  footerVideo: null,
  section: "Tipografía",
  order: 10, 
...
white-space: normal; /* nowrap | pre | pre-wrap | pre-line */`, 
  ...
  footerLinkDemo: 'https://codepen.io/emiarias/pen/vENEzNv',
  footerPreview: null,
  footerVideo: null,
  section: "Tipografía",
  order: 11, 
...
.pegado {
  ...
  top: 0; /* Permanece en el flujo hasta que alcanza 0px desde arriba del viewport, luego se fija */
    ...
    footerLinkDemo: 'https://codepen.io/emiarias/pen/LEpEJZB',
    footerPreview: null,
    footerVideo: null,
...
/* Sin z-index, el orden en el HTML y el tipo de posicionamiento definen el apilamiento */`,
    ...
    footerLinkDemo: 'https://codepen.io/emiarias/pen/jEbEvMr',
    footerPreview: null,
    footerVideo: null,
    section: "Posicionamiento",
    order: 11,
...
.flex-container {
  align-content: center; /* flex-start | flex-end | center | space-between | space-around | stretch */
    ...
    footerLinkDemo: 'https://codepen.io/emiarias/pen/raOaZjG',
    footerPreview: null,
    footerVideo: null,
    section: "Flexbox",
    order: 12,
...
.flex-item {
  align-self: center; /* flex-start | flex-end | center | baseline | stretch */
    ...
    footerLinkInformation:
      "https://developer.mozilla.org/es/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox",
    footerLinkDemo: 'https://codepen.io/emiarias/pen/YPyPOrM',
    footerPreview: null,
    footerVideo: null,
    section: "Flexbox",
    order: 13,
...
.grid-container {
  ...
  align-content: center; /* start | end | center | space-between | space-around | space-evenly */
    ...
    footerLinkDemo: 'https://codepen.io/emiarias/pen/MYaYqQE',
    footerPreview: null,
    footerVideo: null,
    section: "CSS Grid",
    order: 14,
